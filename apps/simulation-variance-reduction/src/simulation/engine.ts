import type { ChartPoint, ChartSeries, CityRecord, ControlValue, ExampleConfig, SimulationResult, TableSpec } from "../components/SimulationVarianceReductionApp/types";
