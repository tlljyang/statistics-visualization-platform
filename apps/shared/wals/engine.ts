import type { ChartPoint, ChartSeries, CityRecord, ControlValue, ExampleConfig, SimulationResult, TableSpec } from "./types";
...
export function runExample(
  ...
  switch (example.kind) {
    ...
    case "central-limit-theorem":
      return centralLimitTheorem(controls, seed, sampleMeans);
    default:
      return result(
        "Template pending",
