...
import { moduleConfig } from "../src/components/MesConfidenceIntervalApp/module-config";
import { createDefaultControls, createState } from "../src/components/MesConfidenceIntervalApp/model";
import { runExample } from "../src/simulation/engine";

describe("MES Confidence Interval", () => {
  it("keeps the migrated WALS source scope in module metadata", () => {
    expect(moduleConfig.sourcePath).toBe("apps/MES/ConfidenceInterval");
