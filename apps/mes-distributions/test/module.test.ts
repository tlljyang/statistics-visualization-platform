...
import { moduleConfig } from "../src/components/MesDistributionsApp/module-config";
import { createDefaultControls, createState } from "../src/components/MesDistributionsApp/model";
import { runExample } from "../src/simulation/engine";

describe("Distributions", () => {
  it("keeps the migrated WALS source scope in module metadata", () => {
    expect(moduleConfig.sourcePath).toBe("apps/MES/Distributions");
