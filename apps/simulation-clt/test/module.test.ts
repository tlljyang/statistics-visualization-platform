...
import { moduleConfig } from "../src/components/SimulationCltApp/module-config";
import { createDefaultControls, createState } from "../src/components/SimulationCltApp/model";
...
describe("Central Limit Theorem", () => {
  it("keeps the migrated WALS source scope in module metadata", () => {
    expect(moduleConfig.sourcePath).toBe("apps/Simulation/CentralLimitTheorem");
