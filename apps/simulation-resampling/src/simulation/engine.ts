import type { ChartBar, ChartPoint, ChartSeries, CityRecord, ControlValue, ExampleConfig, SimulationResult, TableSpec } from "../components/SimulationResamplingApp/types";
