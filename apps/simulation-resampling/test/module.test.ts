...
import { moduleConfig } from "../src/components/SimulationResamplingApp/module-config";
import { createDefaultControls, createState } from "../src/components/SimulationResamplingApp/model";
...
describe("Resampling Methods", () => {
  it("keeps the migrated WALS source scope in module metadata", () => {
    expect(moduleConfig.sourcePath).toBe("apps/Simulation/Resampling");
