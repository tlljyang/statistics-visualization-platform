...
import { moduleConfig } from "../src/components/SimulationMcmcApp/module-config";
import { createDefaultControls, createState } from "../src/components/SimulationMcmcApp/model";
...
describe("Markov Chain Monte Carlo", () => {
  it("keeps the migrated WALS source scope in module metadata", () => {
    expect(moduleConfig.sourcePath).toBe("apps/Simulation/MCMC");
